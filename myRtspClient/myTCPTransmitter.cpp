        ...
        if(dataavailable) {
            switch(m_recvstate) {
                case RECV_LEN: 
                    {
                        ...
                        if(recv(sock, (char*)m_httpTunnelHeaderBuffer, 1, MSG_WAITALL|MSG_PEEK) < 0) {
                            return ERR_RTP_TCPTRANS_ERRORINRECV;
                        }
                        if(m_httpTunnelHeaderBuffer[0] != '$' && m_httpTunnelHeaderBuffer[0] != 'R') {
                            break;
                        } 
                        if(recv(sock, (char*)m_httpTunnelHeaderBuffer, 2, MSG_WAITALL|MSG_PEEK) < 0) {
                            return ERR_RTP_TCPTRANS_ERRORINRECV;
                        }
                        ...
                        if(m_httpTunnelHeaderBuffer[0] == 'R') {
                            if(recv(sock, (char*)m_httpTunnelHeaderBuffer, httpTunnelHeaderLen, MSG_WAITALL|MSG_PEEK) < 0) {
                                return ERR_RTP_TCPTRANS_ERRORINRECV;
                            }
                            if(0 == strncmp((char *)m_httpTunnelHeaderBuffer, "RTSP", 4)) {
                                ...
                                if(recv(sock, (char*)m_httpTunnelHeaderBuffer, 2, MSG_WAITALL) < 0) {
                                    return ERR_RTP_TCPTRANS_ERRORINRECV;
                                }
                                break;
                            }
                        }
                        if(recv(sock, (char*)m_httpTunnelHeaderBuffer, httpTunnelHeaderLen, MSG_WAITALL) < 0) {
                            return ERR_RTP_TCPTRANS_ERRORINRECV;
                        }
                ...
                case RECV_DATA:
                    ...
                    if(recv(sock, (char*)m_pDataBuffer, m_dataLength, MSG_WAITALL) < 0) {
                        return ERR_RTP_TCPTRANS_ERRORINRECV;
                    }
